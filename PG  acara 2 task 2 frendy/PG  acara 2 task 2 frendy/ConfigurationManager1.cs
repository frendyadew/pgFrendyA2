...
namespace PG__acara_2_task_2_frendy
{
    internal class ConfigurationManager1 : ConfigurationManager
    {
        ...
        {
            get { return "PG  acara 2 task 2 frendy"; }
        }
        ...
        protected override ImageSource Icon
        {
            get
            {
                return new BitmapImage(new Uri(@"pack://application:,,,/PG  acara 2 task 2 frendy;component/Images/favicon.ico"));
            }
        }
